...
function clearEventForm() {
    $('#txt-title').val("").css('border-color', 'lightgrey');
    $('#txt-description').val("").css('border-color', 'lightgrey');
    $('#txt-time-date').val("").css('border-color', 'lightgrey');
    $('#txt-title-message').html("");
    $('#txt-description-message').html("");
    $('#txt-time-date-message').html("");
}
...
function validateEventForm() {
    ...
    if (/[^\w\s]/.test($('#txt-title').val())) {
        MessageUtility.MessageBoxWarning('Only _ , text and numbers are allowed in title ')
        isValid = false;
    }
    return isValid;
}
